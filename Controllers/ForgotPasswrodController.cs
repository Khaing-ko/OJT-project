    ...
    public class ForgotPasswordController : BaseController<ForgotPasswordController>
    {
        ...
        public async Task<dynamic> RequestByEmail(ForgotPasswordEmailPayload ObjPayload)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(LoginName) && !string.IsNullOrEmpty(Email))
                {
                    ...
                    var resultAdmin = await _repositoryWrapper.Admin.FindByConditionAsync(adm => adm.AdminLoginName == LoginName);
                    ...
                    if (objAdmin != null)
                    {
                        ...
                        long AdminID = objAdmin.AdminId;
                        if (objAdmin.AdminEmail == Email)
                        {
        ...
        public async Task<dynamic> ChangePasswordByOTP(ChangePasswordOTPPayload ObjPayload)
        {
            ...
            try
            {
                ...
                var objAdmin = (await _repositoryWrapper.Admin.FindByConditionAsync(x => x.AdminLoginName == LoginName)).SingleOrDefault();
                if (objAdmin != null)
                {
                    ...
                    if (otpObject != null)
                    {
                        ...
                        if (otpcode == passcode)
                        {
                            ...
                            // ! EventLog 
                            await _repositoryWrapper.EventLog.Info("Reset Password Successful: " + objAdmin.AdminLoginName);
                        ...
                        else
                        {
                            ...
                            // ! EventLog
                            await _repositoryWrapper.EventLog.Info("Reset Password Fail: " + objAdmin.AdminLoginName);
